...
select 
    *,
    cast (date_trunc('day', timestamp_sent) as date) as date_day,
    cast (date_trunc('week', timestamp_sent) as date) as date_week,
    cast (date_trunc('month', timestamp_sent) as date) as date_month
