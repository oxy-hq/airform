with  __dbt__cte__int_mailchimp__campaign_activities_by_member as (
with recipients as (
...
select * 
from joined
),  __dbt__cte__int_mailchimp__automation_activities_by_member as (
...
from joined
    ...
    select *
    from "mailchimp"."main_stg_mailchimp"."stg_mailchimp__members"

), campaign_activities as (

    select *
    from __dbt__cte__int_mailchimp__campaign_activities_by_member
    ...
    select *
    from __dbt__cte__int_mailchimp__automation_activities_by_member
