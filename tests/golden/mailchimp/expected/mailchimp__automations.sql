...
select * 
from joined
),  __dbt__cte__int_mailchimp__automation_activities_by_automation as (
...
from joined
    ...
    select *
    from __dbt__cte__int_mailchimp__automation_activities_by_automation
