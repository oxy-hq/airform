...
with item_summary as (
    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_summary"
),

item_product_type as (

    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_product_type" 
),

item_image as (

    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_image"
),
...
item_display_group_sales_rank as (
    ...
    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_display_group_sales_rank" 
),

item_classification_sales_rank as (

    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_classification_sales_rank" 
),

item_relationship as (

    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_relationship" 
),
...
item_dimension as (
    ...
    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_dimension" 
),

item_identifier as (

    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__item_identifier" 
),
...
from joined
    ...
    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__orders"
),

order_item as (

    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__order_item"
),
...
order_item_promotion_id as (
    ...
    select *
    from "amazon_selling_partner"."main_stg_amazon_selling_partner"."stg_amazon_selling_partner__order_item_promotion_id"
),
