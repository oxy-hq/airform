with job_department as (
    ...
    select *
    from main_stg_greenhouse.stg_greenhouse__job_department
),

department as (

    select *
    from main_stg_greenhouse.stg_greenhouse__department
),
...
agg_departments as (
    ...
    select
        ...
        job_id,
        STRING_AGG(join_parent_department.name, '; ') as departments,
        STRING_AGG(join_parent_department.parent_department_name, '; ') as parent_departments
