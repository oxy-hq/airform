with __dbt__cte__int_greenhouse__candidate_contacts as (
with candidate as (

    select *
    from "greenhouse"."main_stg_greenhouse"."stg_greenhouse__candidate"
),
...
phones as (
 ...
 as phone
    ...
    from "greenhouse"."main_stg_greenhouse"."stg_greenhouse__phone_number"
...
emails as (
 ...
 as email
    ...
    from "greenhouse"."main_stg_greenhouse"."stg_greenhouse__email_address"
...
order_resumes as (
    ...
    from "greenhouse"."main_stg_greenhouse"."stg_greenhouse__attachment"
...
order_links as (
    ...
    from "greenhouse"."main_stg_greenhouse"."stg_greenhouse__social_media_address"
...
from __dbt__cte__int_greenhouse__candidate_contacts
