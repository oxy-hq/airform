with candidate as (
    ...
    select *
    from main_stg_greenhouse.stg_greenhouse__candidate
),
...
phones as (
    ...
    select 
        source_relation,
        candidate_id,
        STRING_AGG(phone_type || ': ' || phone_number, ', ') as phone

    from main_stg_greenhouse.stg_greenhouse__phone_number
...
emails as (
    ...
    from main_stg_greenhouse.stg_greenhouse__email_address
...
order_resumes as (
    ...
    from main_stg_greenhouse.stg_greenhouse__attachment
...
order_links as (
    ...
    from main_stg_greenhouse.stg_greenhouse__social_media_address
