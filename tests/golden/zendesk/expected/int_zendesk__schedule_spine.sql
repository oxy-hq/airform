...
-- Converts holiday valid_from and valid_until times into minutes from the start of the week, adjusting for timezones.
    ...
    select
        ...
        case when change_type = 'holiday' 
            then (date_diff('minute', holiday_starting_sunday::timestamp, holiday_valid_from::timestamp )
        ...
        case when change_type = 'holiday' 
            then (date_diff('minute', holiday_starting_sunday::timestamp, holiday_valid_until::timestamp )
