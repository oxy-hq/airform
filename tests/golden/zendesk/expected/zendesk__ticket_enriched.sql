...
--If you use using_ticket_form_history this will be included, if not it will be ignored.
    ...
    select *
    from "zendesk"."main_zendesk_intermediate"."int_zendesk__latest_ticket_form"


), latest_satisfaction_ratings as (

    select *
    from "zendesk"."main_zendesk_intermediate"."int_zendesk__ticket_historical_satisfaction"
    ...
    select *
    from "zendesk"."main_zendesk_intermediate"."int_zendesk__requester_updates"

), assignee_updates as (

    select *
    from "zendesk"."main_zendesk_intermediate"."int_zendesk__assignee_updates"
