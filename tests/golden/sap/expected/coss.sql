...
sq_coss_wdv_1 as (
  select
    ...
    case
      when v.set_to_zero = 'x' then cast(0 as NUMERIC)
    ...
    case
      when v.versn != '000' or v.set_to_zero = 'x' then cast(0 as NUMERIC)
      else a.co_megbtr
    end as megbtr,
    case
      when v.versn != '000' or v.set_to_zero = 'x' then cast(0 as NUMERIC)
...
sq_coss_wdv_2 as (
  select
    ...
    v_coss_wdv_1.perio,
    v_coss_wdv_1.meinh,
    cast(v_coss_wdv_1.wtgbtr_add - v_coss_wdv_1.wtgbtr_subtract as NUMERIC) as wtgbtr,
    cast(v_coss_wdv_1.wogbtr_add - v_coss_wdv_1.wogbtr_subtract as NUMERIC) as wogbtr,
    cast(v_coss_wdv_1.wkgbtr_add - v_coss_wdv_1.wkgbtr_subtract as NUMERIC) as wkgbtr,
    cast(v_coss_wdv_1.wkfbtr_add - v_coss_wdv_1.wkfbtr_subtract as NUMERIC) as wkfbtr,
    cast(v_coss_wdv_1.pagbtr_add - v_coss_wdv_1.pagbtr_subtract as NUMERIC) as pagbtr,
    cast(v_coss_wdv_1.pafbtr_add - v_coss_wdv_1.pafbtr_subtract as NUMERIC) as pafbtr,
    v_coss_wdv_1.megbtr,
    v_coss_wdv_1.mefbtr,
    v_coss_wdv_1.muvflg,
    v_coss_wdv_1.beltp,
...
sq_coss_wdv_4 as (
  select
    ...
    case
      when v_coss_wdv_2.timestamp_at > 0 then rtrim(substring(cast(v_coss_wdv_2.timestamp_at as VARCHAR), 1, 4))
      else cast('0000' as VARCHAR)
    end as tsgjahr,
    case
      when v_coss_wdv_2.timestamp_at > 0 then rtrim(substring(cast(v_coss_wdv_2.timestamp_at as VARCHAR), 5, 2))
      else cast('00' as VARCHAR)
    end as tsmonth,
    case
      when v_coss_wdv_2.timestamp_at > 0 then rtrim(substring(cast(v_coss_wdv_2.timestamp_at as VARCHAR), 7, 2))
      else cast('00' as VARCHAR)
    end as tsday,
    case
      when v_coss_wdv_2.timestamp_at > 0 then rtrim(substring(cast(v_coss_wdv_2.timestamp_at as VARCHAR), 9, 2))
      else cast('00' as VARCHAR)
    end as tshour,
    case
      when v_coss_wdv_2.timestamp_at > 0 then rtrim(substring(cast(v_coss_wdv_2.timestamp_at as VARCHAR), 11, 2))
      else cast('00' as VARCHAR)
    end as tsminute,
    case
      when v_coss_wdv_2.timestamp_at > 0 then rtrim(substring(cast(v_coss_wdv_2.timestamp_at as VARCHAR), 13, 2))
      else cast('00' as VARCHAR)
    end as tssecond
...
sq_coss_wdv_6 as (
  select
    ...
    case
      ...
      ) then cast(13 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2036
      or (
        v_coss_wdv_5.tsgjahr0 = 2036
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(12 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2032
      or (
        v_coss_wdv_5.tsgjahr0 = 2032
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(11 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2028
      or (
        v_coss_wdv_5.tsgjahr0 = 2028
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(10 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2024
      or (
        v_coss_wdv_5.tsgjahr0 = 2024
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(9 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2020
      or (
        v_coss_wdv_5.tsgjahr0 = 2020
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(8 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2016
      or (
        v_coss_wdv_5.tsgjahr0 = 2016
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(7 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2012
      or (
        v_coss_wdv_5.tsgjahr0 = 2012
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(6 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2008
      or (
        v_coss_wdv_5.tsgjahr0 = 2008
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(5 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2004
      or (
        v_coss_wdv_5.tsgjahr0 = 2004
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(4 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 2000
      or (
        v_coss_wdv_5.tsgjahr0 = 2000
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(3 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 1996
      or (
        v_coss_wdv_5.tsgjahr0 = 1996
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(2 * 60 * 60 * 24 as INTEGER)
      when v_coss_wdv_5.tsgjahr0 > 1992
      or (
        v_coss_wdv_5.tsgjahr0 = 1992
        and v_coss_wdv_5.tsmonth0 > 2
      ) then cast(1 * 60 * 60 * 24 as INTEGER)
      else cast(0 as NUMERIC)
    end as tsgjahradd,
    case
      when v_coss_wdv_5.tsgjahr0 = 0 then cast(0 as NUMERIC)
      else cast(
        (v_coss_wdv_5.tsgjahr0 - 1990) * 365 * 24 * 60 * 60 as decimal(16, 0)
      )
    end as tsgjahr1,
    case
      when v_coss_wdv_5.tsmonth0 = 1 then cast(0 as NUMERIC)
      when v_coss_wdv_5.tsmonth0 = 2 then cast(31 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 3 then cast(59 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 4 then cast(90 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 5 then cast(120 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 6 then cast(151 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 7 then cast(181 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 8 then cast(212 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 9 then cast(243 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 10 then cast(273 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 11 then cast(304 * 24 * 60 * 60 as INTEGER)
      when v_coss_wdv_5.tsmonth0 = 12 then cast(334 * 24 * 60 * 60 as INTEGER)
      else cast(0 as NUMERIC)
    end as tsmonth1,
    case
      when v_coss_wdv_5.tsday0 = 0 then cast(0 as NUMERIC)
      else cast((v_coss_wdv_5.tsday0 - 1) * 24 * 60 * 60 as INTEGER)
    end as tsday1,
    cast(v_coss_wdv_5.tshour0 * 60 * 60 as INTEGER) as tshour1,
...
sq_coss_wdv_7 as (
  select
    ...
    cast(v_coss_wdv_6.tsgjahradd + cast(v_coss_wdv_6.tsgjahr1 * 60 as NUMERIC) + v_coss_wdv_6.tsmonth1 + v_coss_wdv_6.tsday1 + v_coss_wdv_6.tshour1 + v_coss_wdv_6.tsminute1 + v_coss_wdv_6.tssecond1 as NUMERIC) as tstotalsec
...
sq_coss_wdv_8 as (
  select
    ...
    cast(cast(v_coss_wdv_7.tstotalsec as NUMERIC) * 10000 as NUMERIC) as timestmp
