...
select
    ...
    to_date(cast(erdat as TEXT), 'YYYYMMDD')
 as created_on_date,
    ernam as created_by,
    ...
    to_date(cast(gbdat as TEXT), 'YYYYMMDD')
 as birth_date,
    sexkz as sex,
    kraus as credit_information_number,
    
    to_date(cast(revdb as TEXT), 'YYYYMMDD')
 ...
 as validity_certification_date,
    ...
    to_date(cast(rgdate as TEXT), 'YYYYMMDD')
 as rg_issuing_date,
    ric as ric_number,
    rne as foreign_national_registration,
    
    to_date(cast(rnedate as TEXT), 'YYYYMMDD')
 as rne_issuing_date,
    cnae as cnae_id,
...
from __dbt__cte__int_sap__vendor
