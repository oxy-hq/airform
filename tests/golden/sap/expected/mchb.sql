with stg_sap__matdoc_extract as (
  select *
  from main_sap.stg_sap__matdoc_extract
),

stg_sap__mchb as (
  select *
  from main_sap.stg_sap__mchb
),
...
nsdm_v_mchb_diff as (
  select
    ...
    cast(0 as NUMERIC) as cvmla,
    cast(0 as NUMERIC) as cvmum,
    cast(0 as NUMERIC) as cvmin,
    cast(0 as NUMERIC) as cvmei,
    cast(0 as NUMERIC) as cvmsp,
    cast(0 as NUMERIC) as cvmre,
    sum(
      case nsdm_v_mchb_agg.lbbsa
    ...
    cast(0 as NUMERIC) as _cwm_cvmla,
    cast(0 as NUMERIC) as _cwm_cvmum,
    cast(0 as NUMERIC) as _cwm_cvmin,
    cast(0 as NUMERIC) as _cwm_cvmei,
    cast(0 as NUMERIC) as _cwm_cvmsp,
    cast(0 as NUMERIC) as _cwm_cvmre,
    'x' as chrue
