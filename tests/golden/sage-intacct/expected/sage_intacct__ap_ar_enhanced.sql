...
ap_bill as (
    select * 
    from "sage_intacct"."main_sage_intacct_staging"."stg_sage_intacct__ap_bill" 
), 

ap_bill_item as (
    select * 
    from "sage_intacct"."main_sage_intacct_staging"."stg_sage_intacct__ap_bill_item" 
),
...
ar_invoice as (
    select * 
    from "sage_intacct"."main_sage_intacct_staging"."stg_sage_intacct__ar_invoice" 
),
...
ap_bill_enhanced as (
    select
        ...
        cast(ap_bill_item.offset_gl_account_no as TEXT) as offset_gl_account_no,
    ...
    select
        ...
        cast(ar_invoice_item.offset_gl_account_no as TEXT) as offset_gl_account_no,
